    ...
    <div class="container">
      <div class='bread'>
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>创建个人信息</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <el-row>
        <el-col class='ml-10p' :lg="8" :md="12" :sm="16" :xs="23">
          <div class="title">创建个人信息</div>
          <div class="tips">*为必填</div>
          <el-col :span="24" class='formBar'>
            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="ruleForm">
              <el-form-item label="姓名:" prop="name">
                <el-input v-model="ruleForm.name" suffix-icon="el-icon-document" autocomplete="off" placeholder="请输入姓名"></el-input>
              </el-form-item>
              <el-form-item label="手机号:" prop="tel">
                <el-input v-model.number="ruleForm.tel" suffix-icon="el-icon-mobile-phone" autocomplete="off" placeholder="请输入手机号"></el-input>
              </el-form-item>
              ...
              <el-form-item label="职位:" prop="position">
                <el-input v-model="ruleForm.position" autocomplete="off" placeholder="请输入职位"></el-input>
              </el-form-item>
              <el-form-item label="简介:" prop="bio">
                <el-input type="textarea" :row="2" v-model="ruleForm.bio" autocomplete="off" placeholder="请输入您的介绍 , 兴趣爱好 擅长"></el-input>
              </el-form-item>
              <el-form-item label="个人网址:" prop="website">
                <el-input v-model="ruleForm.website" autocomplete="off" placeholder="请输入您的个人网站或github仓库"></el-input>
              </el-form-item>
              <el-form-item label="github用户名:" prop="githubName">
                <el-input v-model="ruleForm.githubName" autocomplete="off" placeholder="请输入您的github用户名"></el-input>
              </el-form-item>
              <el-form-item>
                <el-switch
                  style="display: block"
              ...
              <div class="linkGroup" v-show="linkSwitch">
                <el-form-item label="QQ:" prop="qq">
                  <el-input v-model="ruleForm.qq" autocomplete="off" placeholder="请输入QQ号"></el-input>
                </el-form-item>
                <el-form-item label="Wechat:" prop="wechat">
                  <el-input v-model="ruleForm.wechat" autocomplete="off" placeholder="请输入您的微信号"></el-input>
                </el-form-item>
              </div>
              <el-form-item>
